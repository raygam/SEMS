...
if Request.Form("ClientEdit")="" then
	...
	DisplayFields = "StudyNumberNew;ClientName;SEMSTestSubstanceName;StudyDescription;StudyType;StudyDirector;Department;OAStatus;TotalStudyCost;ProtocolIssuedDate;ActualExperimentalStartDate;ActualExperimentalEndDate;ActualDraftReportDate;DateStamp"
	...
	if rs.eof=false or rs.bof=false then
		...
		Response.Write "<td><b>SEMS Test Substance</b></td>"
		...
		Response.Write "<td align=right><b>Study Cost</b></td>"
		...
		Response.Write "<td><b>Act Aud Draft to Client</b></td>"
