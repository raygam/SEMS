...
<%
	Response.Write "<h1>Quoted Draft Report Date Changed</h1>"	
	Response.Write "<p>All studies where the <b>QuotedDraftReportDate</b> field has been changed in the last 7 days.</p>"
	...
	Response.Write "<form method=post action=QuotedDraftReportDateChanged.asp>"
...
'Response.Write strsql
	...
	rsAudit.open "SELECT * FROM ChangeLog WHERE ChangeField = 'QuotedDraftReportDate' AND DateStamp >= '" & formatdate(d) & "' ORDER BY RecordID Asc",db
