...
<%
	Response.Write "<h1>Upcoming Quoted Draft Report Date</h1>"	
	Response.Write "<p>All studies where the <b>QuotedDraftReportDate</b> field in the next 45 days and the <b>Actual Audited Draft to Client</b> field is blank.</p>"
	...
	Response.Write "<form method=post action=UpcomingQuotedDraftReportDate.asp>"
	...
	d = dateadd("d",45,now())
	'strsql = "SELECT * FROM Studies WHERE QuotedDraftReportDate >= '" & formatdate(Date) & "' AND QuotedDraftReportDate <= '" & formatdate(d) & "' AND ActualDraftReportDate IS NULL"	
	strsql = "SELECT * FROM Studies WHERE QuotedDraftReportDate >= '" & formatdate(Date) & "' AND ActualDraftReportDate IS NULL"	
	...
	strsql = strsql & " ORDER BY QuotedDraftReportDate ASC"
	'Response.Write strsql & "<br>"
	
	DisplayFields = "Study Number;Financial ClientName;Test Substance Name;Study Description;Study Director;Department;OA Status;Total Study Cost;Protocol Issued Date;Quoted Draft Report Date;Days Until QDRD"
