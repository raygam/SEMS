...
<%
	...
	Response.Write "<p>All studies where the <b>StudyStatus</b> is 'Final', <b>Actual Final Report Issue</b> field is blank and the <b>Actual Archive Date</b> field is blank.</p>"
	...
	Response.Write "<form method=post action=ArchivingReport2.asp>"
	...
	strsql = "SELECT * FROM Studies WHERE StudyStatus = 'Final' AND ReportFinalSignDate IS NULL AND ArchiveActDate IS NULL "	
