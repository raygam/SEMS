<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ExcelExportFull.aspx.vb" Inherits="ExcelExportFull" %>

<!--#Include File="includes\CortexConfig.aspx"-->
        <h1>Creating Full Excel Export....</h1>
    <%
        ...
        If User <> "SSI\DATACRAFTADMIN" And User <> "SSI\HDUNN" And User <> "SSI\FDAVIES" And User <> "SSI\KCOCKS" Then
        ...
        strPath = "c:\Websites\SEMS\wwwroot\Excel\SEMSKeyDataTemplateWithTriggersFull.xlsx"
        ...
        strURL = "http://smrweb:172/Excel/SEMSKeyData" & strDate & "WithTriggersFull.xlsx"
        ...
        Dim f() As String
        strSql = "StudyID,StudyNumber,FinancialClientName,ClientName,TestSubstanceName,StudyDescription,StudyDirector,StudyType,StudyStatus,RegulatoryStatus,ProjectManagementCode,ProjectManager,Department,TotalStudyCost,ExcludeFromOverdue,ProtocolIssuedDate,ActualExperimentalStartDate,ActualExperimentalEndDate,ActualDraftreportDate,QuotedDraftReportDate,ReportFinalSignDate,ReportFinalisationDeadline,ArchiveActDate"


        strSql = "SELECT " & strSql & " FROM Studies ORDER BY StudyNumber ASC"
