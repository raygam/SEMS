...
<%
	Response.Write "<h1>New Studies</h1>"	
	Response.Write "<p>All studies where the <b>Open Accounts Start Date</b> field in the last 7 days</p>"
	...
	Response.Write "<form method=post action=NewStudies.asp>"
	...
	d = dateadd("d",-7,now())
	strsql = "SELECT * FROM Studies WHERE OAStartDate >= '" & formatdate(d) & " 00:00:00'"	
	...
	strsql = strsql & " ORDER BY OAStartDate DESC"
	'Response.Write strsql & "<br>"
	
	DisplayFields = "Study Number;Financial Client Name;Client Name;Test Substance Name;Study Description;Study Director;Department;OpenAcc Status;OpenAcc Start Date;Protocol Issued Date"
